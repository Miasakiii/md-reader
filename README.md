...
**开发进度：** [当前完成度与未完成任务](docs/superpowers/PROJECT_STATUS.md)
...
上述系统文件关联边界已有配置契约测试，但 v1.2.0 候选尚待在独立 Windows 安装环境完成最终验收；当前发布状态见[项目进度](docs/superpowers/PROJECT_STATUS.md)。
